...
| **`v0.18`** (Pruned) | `26ebf27b7cfa` | `f6d06107ee` | 2026-09-05 09:00 | Release v0.18: Web TUI black screen autorecovery, descendant PTY sync, event loop non-blocking offload, account alias caching, zero-glyph watchdog, redraw threshold | Pruned |
| **`v0.17`** (Pruned) | `d7fa1846e1ba` | `b4295a19cc` | 2026-09-03 14:13 | Release v0.17: single container architecture baseline, agy v1.1.25, approval regex O(N^2) anchor fix, heartbeat restoration | Pruned |
| **`v0.16`** (Pruned) | `a6bc3a522f48` | `869610dbbe` | 2026-09-03 07:15 | Single container architecture baseline, agy v1.1.25, main-wrapper background spawn guard | Pruned |
...
| **`v0.13`** (Pruned) | `ede551db54fe` | `fb6178e5f1` | 2026-09-02 05:56 | Baked `agy v1.1.24` into image, hermes-test project isolation, web server public hosts fix, unified 1:1 host mount architecture baseline | Pruned |
