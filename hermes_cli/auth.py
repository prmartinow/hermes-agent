...
PROVIDER_REGISTRY: Dict[str, ProviderConfig] = {
    ...
    "gemini-1": ProviderConfig(
        id="gemini-1",
        name="Google Gemini Account 1",
        auth_type="oauth_external",
        portal_base_url="https://accounts.google.com/o/oauth2/v2/auth",
        inference_base_url=DEFAULT_GEMINI_OAUTH_BASE_URL,
    ),
    "gemini-2": ProviderConfig(
        id="gemini-2",
        name="Google Gemini Account 2",
        auth_type="oauth_external",
        portal_base_url="https://accounts.google.com/o/oauth2/v2/auth",
        inference_base_url=DEFAULT_GEMINI_OAUTH_BASE_URL,
    ),
    "gemini-3": ProviderConfig(
        id="gemini-3",
        name="Google Gemini Account 3",
        auth_type="oauth_external",
        portal_base_url="https://accounts.google.com/o/oauth2/v2/auth",
        inference_base_url=DEFAULT_GEMINI_OAUTH_BASE_URL,
    ),
    "gemini-4": ProviderConfig(
        id="gemini-4",
        name="Google Gemini Account 4",
        auth_type="oauth_external",
        portal_base_url="https://accounts.google.com/o/oauth2/v2/auth",
        inference_base_url=DEFAULT_GEMINI_OAUTH_BASE_URL,
    ),
    "gemini-5": ProviderConfig(
        id="gemini-5",
        name="Google Gemini Account 5",
        auth_type="oauth_external",
        portal_base_url="https://accounts.google.com/o/oauth2/v2/auth",
        inference_base_url=DEFAULT_GEMINI_OAUTH_BASE_URL,
    ),
...
def clear_provider_auth(provider_id: Optional[str] = None) -> bool:
    """
    Clear auth state for a provider. Used by `hermes logout` and Web UI Disconnect.
        ...
        if acc_idx is not None:
            ...
            try:
                ...
                if auth_file.exists():
                    auth_file.unlink()
                    cleared = True
                # Also ensure candidate paths are unlinked
                ...
                for groot in gem_roots:
                    ...
                    if acc_idx == 1:
                        cand_names = ["antigravity-oauth-token", "antigravity-oauth-token-1", "antigravity-oauth-token.1"]
                    else:
                        cand_names = [f"antigravity-oauth-token-{acc_idx}", f"antigravity-oauth-token.{acc_idx}"]
