...
const modelLabel = (model: string, effort?: string, fast?: boolean, account?: string, effortWire?: string) =>
  [shortModelLabel(model) + (account ? ` · ${account}` : ''), effortLabel(effort, effortWire), fast ? 'fast' : '']
    .filter(Boolean)
    .join(' ')
...
export function StatusRule({
  ...
  const modelText = modelLabel(model, modelReasoningEffort, modelFast, modelAccount, modelReasoningEffortWire)
