...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **`v0.18`** | `d8dc4634dc1d` | `3be97fff07` | 2026-09-05 08:32 | Release v0.18: Web TUI black screen autorecovery, zero-glyph watchdog, descendant session PTY sync, PTY keepalive redraw buffer threshold | **Active (Serving :9119)** |
