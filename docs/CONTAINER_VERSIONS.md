...
| :--- | :---: | :--- | :--- | :--- |
| **`hermes-agent-serving`** | `9119` | `hermes-agent:v0.17` (`v0.17`, `local`) | `docker-compose.local.yml` | Active production serving & leader lease holder |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **`v0.17`** | `d7fa1846e1ba` | `b4295a19cc` | 2026-09-03 14:13 | Release v0.17: single container architecture baseline, agy v1.1.25, approval regex O(N^2) anchor fix, heartbeat restoration | **Active (Serving :9119)** |
